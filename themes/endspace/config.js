...
const CONFIG = {
  ...
  // 加载动画显示的站点名称 (右侧竖排大字)
  ENDSPACE_LOADING_SITE_NAME: 'Skim_67', // 站点名称，显示在加载动画右侧
  ...
  ENDSPACE_LOADING_IMAGE: 'https://www.loliapi.com/acg/', // 加载动画中显示的图片（默认使用站点 favicon SVG）
  ...
  ENDSPACE_BANNER_WATERMARK_TEXT: 'Skim_67',
  // 文章详情页右上角水印文字
  ENDSPACE_ARTICLE_WATERMARK_TEXT: 'Skim_67',
