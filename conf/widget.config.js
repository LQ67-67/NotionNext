...
module.exports = {
  ...
  WIDGET_PET_LINK:
    ...
    'https://cdn.jsdelivr.net/npm/live2d-widget-model-nepmaid/assets/nepmaid.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://raw.githubusercontent.com/LQ67-67/NotionNext/main/conf/6638.mp3',  //https://music.163.com/song/media/outer/url?id=731419.mp3
      cover:
    ...
    },
    {
      ...
      url: 'https://raw.githubusercontent.com/LQ67-67/NotionNext/main/conf/8015.mp3',  //https://music.163.com/song/media/outer/url?id=731355.mp3
  ...
  MUSIC_PLAYER_METING_SERVER:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_SERVER || 'xiami', // 音乐平台，[netease, tencent, kugou, xiami, baidu]
